...
describe('layout', () => {
    ...
    it('should consider the `project` option', () => __awaiter(void 0, void 0, void 0, function* () {
        appTree = yield schematicRunner.runSchematic('application', Object.assign(Object.assign({}, appOptions), { name: 'testApp2', projectRoot: 'projects/testApp2' }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
    ...
    it('should merge build commands in devextreme.json file', () => __awaiter(void 0, void 0, void 0, function* () {
        appTree = yield schematicRunner.runSchematic('application', Object.assign(Object.assign({}, appOptions), { name: 'testApp2', prefix: 'app2', projectRoot: 'projects/testApp2' }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
